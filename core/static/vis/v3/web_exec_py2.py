...
#request = {u'raw_input_json': [u''], u'user_script': [u'i = 11\ni = i + 1'], u'options_json': [u'{"cumulative_mode":false,"heap_primitives":false,"show_only_outputs":false,"py_crazy_mode":false,"origin":"opt-frontend.js"}']}
