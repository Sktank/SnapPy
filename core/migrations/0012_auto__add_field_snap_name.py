...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Snap.name'
        db.add_column(u'core_snap', 'name',
                      self.gf('django.db.models.fields.CharField')(default='untitled', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Snap.name'
        db.delete_column(u'core_snap', 'name')
