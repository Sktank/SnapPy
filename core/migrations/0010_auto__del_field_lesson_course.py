...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'core_lesson_courses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lesson', models.ForeignKey(orm[u'core.lesson'], null=False)),
            ('course', models.ForeignKey(orm[u'core.course'], null=False))
        ))
        db.create_unique(m2m_table_name, ['lesson_id', 'course_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'core_lesson_courses'))
