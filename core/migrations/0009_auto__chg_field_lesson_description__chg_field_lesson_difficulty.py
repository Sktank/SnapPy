...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'core_lesson', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Lesson.difficulty'
        db.alter_column(u'core_lesson', 'difficulty', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Lesson.description'
        db.alter_column(u'core_lesson', 'description', self.gf('django.db.models.fields.TextField')(default='None'))

        # Changing field 'Lesson.difficulty'
        db.alter_column(u'core_lesson', 'difficulty', self.gf('django.db.models.fields.IntegerField')(default=-1))
